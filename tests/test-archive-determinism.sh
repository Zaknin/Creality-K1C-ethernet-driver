...
first=$(sha256sum "$ROOT/dist/k1c-usb-ethernet-build-tools-v0.1.0.tar.gz" "$ROOT/dist/k1c-usb-ethernet-build-tools-v0.1.0.zip")
python3 "$ROOT/tools/build-release-archives.py" >/tmp/k1c-archive-2.out
second=$(sha256sum "$ROOT/dist/k1c-usb-ethernet-build-tools-v0.1.0.tar.gz" "$ROOT/dist/k1c-usb-ethernet-build-tools-v0.1.0.zip")
